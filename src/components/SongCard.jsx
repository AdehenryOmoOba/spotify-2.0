  ...
  return (
    ...
    <div className="relative w-full h-56 group">
      <div className={`absolute inset-0 justify-center items-center bg-black bg-opacity-50 group-hover:flex ${activeSong?.title === song.title ? 'flex bg-opacity-70' : 'hidden'}`}>
        <PlayPause song={song} handlePlayClick={handlePlayClick} handlePauseClick={handlePauseClick} isPlaying={isPlaying} activeSong={activeSong} />
      </div>
      <img src={song?.images?.coverart} alt="album_cover" />
    </div>
