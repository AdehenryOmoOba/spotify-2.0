...
const SongDetails = () => {
    ...
    const {data:relatedSongData, isFetching:isFetchingRelatedSongDetails, error} = useGetRelatedSongsQuery(songid)
    ...
    return (
        <div className="flex flex-col"> 
            ...
            <RelatedSongs data={relatedSongData} isPlaying={isPlaying} activeSong={activeSong} handlePauseClick={handlePauseClick} handlePlayClick={handlePlayClick} />
        </div>
    )
};
